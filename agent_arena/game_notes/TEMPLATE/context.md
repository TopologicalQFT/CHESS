...
<!-- Bishop pair, opposite-side castling, space, weak color complex,
     material imbalance (R vs B+N, etc.). What each side has that the
     other doesn't — imbalances are where plans come from. -->
