...
1. **List the attackers of the square, both sides, by value ascending.** Yours: "P(1), N(3), R(5)". Theirs: "P(1), Q(9)". Get this list from `inspect_square` or `hanging_report` — not from memory.
